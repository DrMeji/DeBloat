      ...
      <div className="ultimate-warning">
        <div className="ultimate-warning-card">
          ...
          <ul className="ultimate-warning-list">
            <li>Can <strong>completely disable Defender, Firewall, SmartScreen, and UAC</strong> (turn off Tamper Protection first, then reboot after applying).</li>
            ...
            <li>Multi-monitor Portrait/Landscape layout is preserved (Display Policy is kept on).</li>
