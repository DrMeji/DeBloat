...
const ultimateExtra: Tweak[] = [
  ...
  },
  {
    ...
    recommended: false,
    type: 'command',
    target: `$ErrorActionPreference='SilentlyContinue'; New-Item 'HKLM:\\SOFTWARE\\Policies\\Microsoft\\Windows\\System' -Force | Out-Null; New-Item 'HKLM:\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer' -Force | Out-Null; New-Item 'HKCU:\\Software\\Microsoft\\Windows\\CurrentVersion\\AppHost' -Force | Out-Null; Set-ItemProperty 'HKLM:\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer' SmartScreenEnabled 'Off' -Type String -Force; Set-ItemProperty 'HKLM:\\SOFTWARE\\Policies\\Microsoft\\Windows\\System' EnableSmartScreen 0 -Type DWord -Force; Set-ItemProperty 'HKCU:\\Software\\Microsoft\\Windows\\CurrentVersion\\AppHost' EnableWebContentEvaluation 0 -Type DWord -Force; Write-Output 'SmartScreen disabled'; exit 0`,
    undo: `$ErrorActionPreference='SilentlyContinue'; Set-ItemProperty 'HKLM:\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer' SmartScreenEnabled 'On' -Type String -Force; Set-ItemProperty 'HKLM:\\SOFTWARE\\Policies\\Microsoft\\Windows\\System' EnableSmartScreen 1 -Type DWord -Force; exit 0`,
  },
  {
  ...
  },
  {
    ...
    recommended: false,
    type: 'service',
    target: 'TabletInputService,TextInputManagementService',
    value: { startup: 'disabled' },
    undo: { startup: 'manual' },
  },
  {
